...
/** Fixed value used for leading/trailing position of first trigger view during a swipe. Only applies if shouldAnimateIcons is NO. */
@property (nonatomic, assign, readwrite) CGFloat firstTriggerPosition;
